...
const About = () => {
  ...
  return (
    <div className="grid lg:grid-cols-12 md:grid-cols-6 grid-cols-6 lg:gap-8 md:gap-6 gap-4 items-center bg-whiteBackground">
      <div></div>
      <div className="h-full text-navText font-humanist777 lg:col-span-10 md:col-span-4 col-span-4">
        <div className={`mb-16 max-w-[910px] overflow-hidden lg:h-[540px] md:h-[340px] ${isMobile ? "h-[140px]" : "h-[240px]"}`}>
